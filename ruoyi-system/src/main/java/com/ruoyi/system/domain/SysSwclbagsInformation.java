...
/**
 * 涉外车辆备案公司认证对象 sys_swclbags_information
 * 
 * @author ruoyi
 * @date 2025-11-19
 */
public class SysSwclbagsInformation extends BaseEntity
{
    ...
    public void setShewaiZizhi(String shewaiZizhi) 
    {
        this.shewaiZizhi = shewaiZizhi;
    }

    public String getShewaiZizhi() 
    {
        return shewaiZizhi;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("shewaiZizhi", getShewaiZizhi())
            .toString();
    }
}
