...
const user = {
  ...
  actions: {
    ...
    Login({ commit }, userInfo) {
      ...
      const loginType = userInfo.loginType || 'username'
      const phone = userInfo.phone ? userInfo.phone.trim() : ''
      const email = userInfo.email ? userInfo.email.trim() : ''
      return new Promise((resolve, reject) => {
        login(username, password, code, uuid, loginType, phone, email).then(res => {
          setToken(res.token)
